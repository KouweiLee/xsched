/// This file is auto-generated by command "python3 tools/autogen/gen.py --source ./platforms/cuda/hal/include/xsched/cuda/hal/common/cuda.h  --platform cuda --prefix cu --lib /usr/lib/x86_64-linux-gnu/libcuda.so"
#pragma once
...
public:
    ...
    // cudaEGL.h
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuGraphicsEGLRegisterImage"), CUresult, GraphicsEGLRegisterImage, CUgraphicsResource *, pCudaResource, EGLImageKHR, image, unsigned int, flags);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamConsumerConnect"), CUresult, EGLStreamConsumerConnect, CUeglStreamConnection *, conn, EGLStreamKHR, stream);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamConsumerConnectWithFlags"), CUresult, EGLStreamConsumerConnectWithFlags, CUeglStreamConnection *, conn, EGLStreamKHR, stream, unsigned int, flags);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamConsumerDisconnect"), CUresult, EGLStreamConsumerDisconnect, CUeglStreamConnection *, conn);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamConsumerAcquireFrame"), CUresult, EGLStreamConsumerAcquireFrame, CUeglStreamConnection *, conn, CUgraphicsResource *, pCudaResource, CUstream *, pStream, unsigned int, timeout);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamConsumerReleaseFrame"), CUresult, EGLStreamConsumerReleaseFrame, CUeglStreamConnection *, conn, CUgraphicsResource, pCudaResource, CUstream *, pStream);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamProducerConnect"), CUresult, EGLStreamProducerConnect, CUeglStreamConnection *, conn, EGLStreamKHR, stream, EGLint, width, EGLint, height);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamProducerDisconnect"), CUresult, EGLStreamProducerDisconnect, CUeglStreamConnection *, conn);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamProducerPresentFrame"), CUresult, EGLStreamProducerPresentFrame, CUeglStreamConnection *, conn, CUeglFrame, eglframe, CUstream *, pStream);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEGLStreamProducerReturnFrame"), CUresult, EGLStreamProducerReturnFrame, CUeglStreamConnection *, conn, CUeglFrame *, eglframe, CUstream *, pStream);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuGraphicsResourceGetMappedEglFrame"), CUresult, GraphicsResourceGetMappedEglFrame, CUeglFrame *, eglFrame, CUgraphicsResource, resource, unsigned int, index, unsigned int, mipLevel);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuEventCreateFromEGLSync"), CUresult, EventCreateFromEGLSync, CUevent *, phEvent, EGLSyncKHR, eglSync, unsigned int, flags);

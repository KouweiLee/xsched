...
static const std::unordered_map<std::string, std::map<int, void *>> intercept_funcs = {
    ...
    { "cuProfilerInitialize"                                , {{  4000, (void *)cuProfilerInitialize                                }}},
    { "cuProfilerStart"                                     , {{  4000, (void *)cuProfilerStart                                     }}},
    { "cuProfilerStop"                                      , {{  4000, (void *)cuProfilerStop                                      }}},

    { "cuGraphicsEGLRegisterImage"                          , {{  7000, (void *)cuGraphicsEGLRegisterImage                          }}},
    { "cuEGLStreamConsumerConnect"                          , {{  7000, (void *)cuEGLStreamConsumerConnect                          }}},
    { "cuEGLStreamConsumerConnectWithFlags"                 , {{  8000, (void *)cuEGLStreamConsumerConnectWithFlags                 }}},
    { "cuEGLStreamConsumerDisconnect"                       , {{  7000, (void *)cuEGLStreamConsumerDisconnect                       }}},
    { "cuEGLStreamConsumerAcquireFrame"                     , {{  7000, (void *)cuEGLStreamConsumerAcquireFrame                     }}},
    { "cuEGLStreamConsumerReleaseFrame"                     , {{  7000, (void *)cuEGLStreamConsumerReleaseFrame                     }}},
    { "cuEGLStreamProducerConnect"                          , {{  7000, (void *)cuEGLStreamProducerConnect                          }}},
    { "cuEGLStreamProducerDisconnect"                       , {{  7000, (void *)cuEGLStreamProducerDisconnect                       }}},
    { "cuEGLStreamProducerPresentFrame"                     , {{  7000, (void *)cuEGLStreamProducerPresentFrame                     }}},
    { "cuEGLStreamProducerReturnFrame"                      , {{  7000, (void *)cuEGLStreamProducerReturnFrame                      }}},
    { "cuGraphicsResourceGetMappedEglFrame"                 , {{  7000, (void *)cuGraphicsResourceGetMappedEglFrame                 }}},
    { "cuEventCreateFromEGLSync"                            , {{  9000, (void *)cuEventCreateFromEGLSync                            }}},
